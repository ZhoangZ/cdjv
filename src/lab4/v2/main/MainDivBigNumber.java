...
public class MainDivBigNumber {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100; i++) {
			...
			System.out.println(String.format("rs = bigNumber.div(new MyBigNumber(\"%s\"));",number2));
			System.out.println(String.format("assertEquals(rs[0].toString(), \"%s\");",Integer.parseInt(number1)/Integer.parseInt(number2)));
			System.out.println(String.format("assertEquals(rs[1].toString(), \"%s\");",Integer.parseInt(number1)%Integer.parseInt(number2)));
